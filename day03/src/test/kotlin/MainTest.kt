...
class MainTest {
    ...
    fun `example1 distance is 6`(){
        ...
        val result = calcualteClosestIntersection(wire1, wire2)
        assertEquals(6, result)
    }
    @Test
    fun `example2 distance is 159`(){
